...
namespace HoaDon_API.Migrations
{
    ...
    [Migration("20240308014916_setup1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoaDon_API.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("HoaDon_API.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HoaDon_API.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HoaDon_API.Models.Chitiethoadon", b =>
                {
                    b.HasOne("HoaDon_API.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("HoaDon_API.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
